(function (root, factory) {
  ...
  (function (globalRoot, Chartist) {
    ...
    let {window} = globalRoot;
    let {document} = globalRoot;
...
sourceProp;
    ...
    Chartist.serialMap = function (arr, cb) {
      let result = [];
        var length = Math.max.apply(null, arr.map((e) => {
          return e.length;
        }));

      Chartist.times(length).forEach((e, index) => {
    ...
    Chartist.deserialize = function (data) {
      ...
      data = Object.keys(Chartist.escapingMap).reduce((result, key) => {
    ...
    Chartist.normalizeData = function (data, reverse, multi) {
      ...
      Array.prototype.push.apply(
        ...
        Chartist.times(Math.max(0, labelCount - output.normalized.labels.length)).map(() => {
          return '';
        }),
      );
 ...
 */
  ...
  (function (globalRoot, Chartist) {
    ...
    function cloneDefinitions() {
      ...
      args.splice(1, args.length - 1).forEach((source) => {
 ...
 */
  ...
  (function (globalRoot, Chartist) {
    ...
    function removeClass(names) {
      ...
      this._node.setAttribute('class', this.classes(this._node).filter((name) => {
    ...
    function SvgList(nodeList) {
      ...
      Object.keys(Chartist.Svg.prototype).filter((prototypeProperty) => {
        return ['constructor',
          'parent',
          'querySelector',
          'querySelectorAll',
 ...
 */
  ...
  (function (globalRoot, Chartist) {
    ...
    function clone(close) {
      ...
      c.pos = this.pos;
      c.pathElements = this.pathElements.slice().map((pathElement) => {
  ...
  (function (globalRoot, Chartist) {
    ...
    function createChart(options) {
      ...
      if (options.distributeSeries) {
        ...
        data.normalized.series = data.normalized.series.map((value) => {
          return [value];
        });
      } else {
        data = Chartist.normalizeData(this.data, options.reverseData, options.horizontalBars ? 'x' : 'y');
      ...
      if (options.stackBars && data.normalized.series.length !== 0) {
        ...
        let serialSums = Chartist.serialMap(data.normalized.series, function serialSums() {
          return Array.prototype.slice.call(arguments).map((value) => {
            return value;
          }).reduce((prev, curr) => {
            return {
  ...
  (function (globalRoot, Chartist) {
    ...
    function determineAnchorPosition(center, label, direction) {
      ...
      if (toTheRight && direction === 'explode' ||
        ...
        return 'start';
      } if (toTheRight && direction === 'implode' ||
    ...
    function createChart(options) {
      ...
      totalDataSum = options.total || data.normalized.series.reduce((previousValue, currentValue) => {
      ...
      let hasSingleValInSeries = data.raw.series.filter((val) => {
